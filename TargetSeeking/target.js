class Target {
    constructor() {
        this.position = createVector(game.width/2, game.height/2);
    ...
    update() {
        ...
        if (this.position.x < 50 || this.position.x > game.width - 50 || this.position.y < 50 || this.position.y > game.height - 50) {
